...
export const PortletHeaderTitle = forwardRef(({ className, ...props }, ref) => (
	...
	<h3 {...props} ref={ref} className={clsx('kt-portlet__head-title', className)} />
));

export const PortletHeaderToolbar = forwardRef(({ className, ...props }, ref) => (
	<div {...props} ref={ref} className={clsx('kt-portlet__head-toolbar', className)} />
));

export const PortletHeader = forwardRef(
	({ icon, title, toolbar, className, sticky = false, labelRef, ...props }, ref) => {
		...
		return (
			...
			>
				{title != null && (
					<div ref={labelRef} className={clsx('kt-portlet__head-label', className)}>
						{icon}
...
export const PortletBody = forwardRef(({ fit, fluid, className, ...props }, ref) => (
	<div
		{...props}
		ref={ref}
		className={clsx(
...
export const Portlet = forwardRef(({ fluidHeight, className, ...props }, ref) => (
	<div {...props} ref={ref} className={clsx('kt-portlet', { 'kt-portlet--height-fluid': fluidHeight }, className)} />
));
